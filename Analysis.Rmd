...
I do a 100 splits in training and test-data and and calculate the mean l1-error over those. I get:
...
mean_errors <- data.frame(names=c("GAM", "GLM", "Linear with log-trafo", "Linear model"), mean_error_value=c(mean(gam_error), mean(glm_error), mean(log_trafo_error), mean(linear_error)))
